        ...
        execute: function () {
            ...
            _export('NegociacoesView', NegociacoesView = function (_View) {
                ...
                function NegociacoesView(elemento) {
                    ...
                    //Como a classe é extendida de View, ela herda os metodos, mas tem que passar o paramentro elemento 
                ...
                _createClass(NegociacoesView, [{
                    ...
                    value: function template(model) {
                        ...
                        return '\n        <table class="table table-hover table-bordered">\n            <thead>\n                <tr>\n                <th >DATA</th>\n                <th >QUANTIDADE</th>\n                <th >VALOR</th>\n                <th >VOLUME</th>\n            </tr>\n            </thead>\n            \n            <tbody>\n                ' + model._negociacoes.map(function (n) {
                            return '\n                        <tr>\n                            <td>' + DateHelper.dataParaTexto(n.data) + '    </td>\n                            <td>' + n.quantidade + '</td>\n                            <td>' + n.valor + '</td>\n                            <td>' + n.volume + '</td>\n                        </tr>\n                    \n                    ';
                        }).join('') + '\n            </tbody>\n            \n            <tfoot>\n                <td colspan=\'3\'></td>\n                <td>\n                    ' + model.volumeTotal + '\n                    <!-- ' + model._negociacoes.reduce(function (total, n) {
