<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cursos.aspx.cs" Inherits="BarbeirosDeSucesso.Cursos" %>
...
<body>
    ...
    <div class="page">
        ...
        <!-- Breadcrumbs -->
        <section class="section novi-background breadcrumbs-custom bg-image context-dark" style="background-image: url(images/bannercursos.jpg);">
        ...
        <section class="section novi-background section-md text-center">
            <div class="container">
                <h3 class="text-uppercase font-weight-bold wow-outer"><span class="wow slideInDown">Nosso cursos</span></h3>

                <h5 class="text-uppercase font-weight-bold wow-outer"><span class="wow slideInDown">Em Breve!!</span></h5>
            ...
            <div class="col-md-12 wow-outer"><a class="button button-primary button-winona button-md" href="Pacotes.aspx">Visualizar mais eventos</a></div>
          </div>--%>
            </div>
        </section>
