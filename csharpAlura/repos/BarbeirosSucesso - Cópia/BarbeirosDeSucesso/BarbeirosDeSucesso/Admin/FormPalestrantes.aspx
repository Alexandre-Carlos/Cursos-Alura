<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormPalestrantes.aspx.cs" Inherits="BarbeirosDeSucesso.Admin.FormPalestrante" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12" id="divCadPalestrante" style="display:block" runat="server">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <br />
                                    <form  id="FormPalestrantes" name="FormPalestrantes" runat="server" class="form-horizontal form-label-left">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="txtAtivo" runat="server" name="ativo" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12"> 
                                                <input type="text" id="txtDataCadastro" runat="server" name="DataCadastro" class="form-control col-md-7 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12"> 
                                                <input type="text" id="txtFoto" runat="server" name="Foto" class="form-control col-md-7 col-xs-12">
                                        ...
                                        <div class="form-group" id="divGravaPalestrante" runat="server" style="display:block;">
                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3" style="text-align: center;">
                                                <asp:Button ID="btnGravaPalestrante" runat="server" class="btn btn-success" OnClick="btnGravaPalestrante_Click" Text="Aprovar" />
