<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DetalhesEvento.aspx.cs" Inherits="BarbeirosDeSucesso.DetalhesEvento" %>
...
<body>
    ...
    <div class="page">
        ...
        <div class="container">
          <h3 class="text-uppercase font-weight-bold wow-outer"><span class="wow slideInDown">Em desenvolvimento</span></h3>
          <%--<div class="row row-lg-50 row-35 offset-top-2">
            ...
            <div class="col-md-12 wow-outer"><a class="button button-primary button-winona button-md" href="#">Eventos Antigos</a></div>
          </div>--%>
        </div>
      </section>
