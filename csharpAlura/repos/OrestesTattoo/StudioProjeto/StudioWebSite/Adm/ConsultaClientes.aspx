<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultaClientes.aspx.cs" Inherits="StudioWebSite.Adm.ConsultaClientes" %>
                ...
                <div class="">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12" id="div1" style="display: block" runat="server">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <div class="table-responsive" > <%--id="GridUser" runat="server"--%>
                                    <table class="table table-striped jambo_table bulk_action">
                                        <thead>
                                            <tr class="headings">
                                                ...
                                                <th class="column-title">Nascimento </th>
