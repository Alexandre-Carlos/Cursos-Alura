<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormCadUSuario.aspx.cs" Inherits="StudioWebSite.Adm.FormCadUSuario" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12" id="divCadUsuario" runat="server">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <br />
                                    <form id="cadUsuario" data-parsley-validate class="form-horizontal form-label-left" runat="server">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <%--required="required"--%>
                                                <input type="text" id="txtnomeCompleto" class="form-control col-md-7 col-xs-12" runat="server" required="required">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="txtCpfUser" class="form-control col-md-7 col-xs-12" type="text" onkeydown="javascript: fMasc(this, mCPF );" maxlength="14" runat="server" required="required">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="txtLogin" class="form-control col-md-7 col-xs-12" runat="server" required="required">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="txtsenha" class="form-control col-md-7 col-xs-12" type="password" runat="server" required="required">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">ConfirmarSenha
                                                <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="txtConfSenha" class="form-control col-md-7 col-xs-12" type="password" runat="server" required="required">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div id="sexoUserGroup" class="btn-group" data-toggle="buttons">
                                                    <label class="btn btn-default active" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                                        <input type="radio" name="gender" value="M" checked runat="server">
                                                        Masculino
                           
                                                    </label>
                                                    <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                                        <input type="radio" name="gender" value="F" runat="server">
                                                        Feminino
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <asp:FileUpload ID="fotouser" class="form-control col-md-7 col-xs-12" runat="server"/>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Usuário Ativo?</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="chkAtivo" class="form-control col-md-7 col-xs-12" type="checkbox" name="chkAtivo" runat="server">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3" style="text-align: center;">
                                                ...
                                                <asp:Button ID="btnGravaUser" runat="server" class="btn btn-success" OnClick="btnGravaUser_Click" Text="Gravar" />
                                            </div>
                                        </div>
