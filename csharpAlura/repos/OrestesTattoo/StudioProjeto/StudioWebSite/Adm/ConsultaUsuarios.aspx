<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultaUsuarios.aspx.cs" Inherits="StudioWebSite.Adm.ConsultaUsuarios" %>
                            ...
                            <div class="x_content">
                                <div class="table-responsive" > <%--id="GridUser" runat="server"--%>
                                    <%--<form id="form1" runat="server">
                                        <asp:GridView ID="myGrid" CssClass="table table-striped jambo_table bulk_action" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
