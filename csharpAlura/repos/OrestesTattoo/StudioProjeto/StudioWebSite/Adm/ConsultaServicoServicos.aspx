<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultaServicoServicos.aspx.cs" Inherits="StudioWebSite.Adm.ConsultaServicoServicos" %>
...
<body class="nav-md">
                ...
                <div class="">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12" id="div1" style="display: block" runat="server">
                        <form id="consultaData" runat="server">
                            ...
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Consulta de serviços por cliente</h2>
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:Button ID="btnConsultarPorServico" runat="server" class="btn btn-success" OnClick="btnConsultarPorServico_Click" Text="Consultar" />
    ...
    <script>
        $(document).ready(function () {
            $.ajax({
                type: "POST",
                url: "ConsultaServicoCliente.aspx/RecuperaCliente",
                contentType: "application/json; charset=utf-8",
                data: "{}",
                dataType: "json",
