<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Galeria.aspx.cs" Inherits="StudioWebSite.Galeria" %>
  ...
  <!-- 
	...
	<div id="fh5co-page">
		...
		<div id="fh5co-photos-section">
			<div class="container">
				<div class="row text-center" runat="server" id="GaleriaTattoo"></div>
			</div>
		</div>
		<footer>
			<div id="footer">
