<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LojaStudio.aspx.cs" Inherits="StudioWebSite.LojaStudio" %>
  ...
  <!-- 
	...
	<div id="fh5co-page">
		...
		<div id="fh5co-photos-section">
			<div class="container">
				<div class="row text-center" runat="server" id="LojaGaleria"></div>
			</div>
		</div>
		<footer>
			<div id="footer">
