    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthentication()
                    ...
                    {
                        options.ClientId = Configuration["ExternalLogin:Microsoft:ClienteId"];
                        options.ClientSecret = Configuration["ExternalLogin:Microsoft:ClienteSecret"];
                    })
                    .AddGoogle(options =>
                    {
                        options.ClientId = Configuration["ExternalLogin:Google:ClienteId"];
                        options.ClientSecret = Configuration["ExternalLogin:Google:ClienteSecret"];
                    });
